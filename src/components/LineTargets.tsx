    ...
    <div className="space-y-6">
      <ChartContainer title="Line 100% Target vs Capacity" icon={<Target className="h-5 w-5 text-indigo-600" />}>
        <div className="overflow-x-auto w-full pb-4 scrollable-chart-area flex-1" style={{ WebkitOverflowScrolling: 'touch' }}>
           <div className="scrollable-chart-inner" style={{ width: isFullscreen ? '100%' : `${Math.max(1200, lineData.length * 60)}px`, height: isFullscreen ? 'auto' : '650px', minHeight: isFullscreen ? '800px' : '650px' }}>
             <ResponsiveContainer width="100%" height={isFullscreen ? 800 : "100%"} minHeight={800}>
               <LineChart layout={isFullscreen ? "vertical" : "horizontal"} data={lineData} margin={{ top: 20, right: 30, left: isFullscreen ? 150 : 20, bottom: isFullscreen ? 20 : 180 }}>
