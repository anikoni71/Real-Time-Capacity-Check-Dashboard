    ...
    <div className="lg:col-span-2 flex flex-col h-full">
      ...
      >
        ...
        <div className="overflow-x-auto w-full border border-gray-100 rounded-md pb-4 scrollable-chart-area flex-1" style={{ WebkitOverflowScrolling: 'touch' }}>
           <div className="scrollable-chart-inner" style={{ width: isFullscreen ? '100%' : `${expectedWidth}px`, height: isFullscreen ? 'auto' : '600px', minHeight: isFullscreen ? `${Math.max(chartData.length * 30, 800)}px` : undefined }}>
