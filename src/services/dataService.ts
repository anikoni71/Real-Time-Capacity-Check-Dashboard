...
const CSV_URL =
  "https://docs.google.com/spreadsheets/d/e/2PACX-1vQZSDm3DPmRxekpTtPJvpckT7GnabbFTTzASEAiEKKctZZ1-cbDJSnyK-rkJlhV0G4BXF4-VrdPUh0W/pub?gid=529052641&single=true&output=csv";
          ...
          results.data.forEach((row: any) => {
            ...
            if (sl) {
              processes.push({
                ...
                avgMin:
                  parseFloat(getVal("Avg Min")) ||
                  parseFloat(getVal("OB SMV")) ||
                  0,
                tt100:
                  parseFloat(getVal("100% T&T")) ||
                  parseFloat(getVal("Tack Time (Sec)")) ||
                  0,
